const demoIndex = {
    ...
    "/guide/basic-components/": require("../content/examples/basic-components/samples"),
    "/validators/introduction/": require("../content/validators/introduction/samples"),
    "/tunnels/introduction/": require("../content/tunnels/introduction/samples"),
    "/examples/wizard-form/": require("../content/examples/wizard-form/samples"),
};
